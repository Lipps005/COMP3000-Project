...
self.addEventListener('fetch', function (event) {
   ...
   event.respondWith(
           caches
           .match(event.request) //promise that resolves into a cache entry we can serve to the response.
           .then(function (cached) {
              ...
              function fetchedFromNetwork(response) {
                 var cacheCopy = response.clone(); //create a copy of the reponse to store in cache
